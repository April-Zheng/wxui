 ...
 * @Description: 
 * @version: 
 * @Date: 2019-09-03 11:20:07
 * @LastEditors: zlp
 * @LastEditTime: 2019-09-03 16:34:52
 */
module.exports = Behavior({
    ...
    properties: {
        ...
        /**
         * 为second时 time小于0 从0开始 目标时间为time的绝对值；time>0 从time开始 到0结束
         */
        timeType: {
            type: String,
            value: 'datetime'
        ...
        /**
         * anniversary纪念日模式 计算距离设定时间过去多久 timeType必须为datetime
         */
        countdownType: {
            type: String,
            value: 'normal'
